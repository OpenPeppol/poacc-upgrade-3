...
In the table below you will find the values to be used as the specification identifier and the business process type for this profile and for the Billing with Response profile. The "Billing with Response" profile is a process where the Invoice response is a required step in the collaboration. Test {prof-66}
