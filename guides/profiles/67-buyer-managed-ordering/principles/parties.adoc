...
The table below gives the definitions of the parties and roles of the Buyer Managed Ordering process.

The roles are the same as in {link-bis-65}. The difference is that in this BIS the seller is a receiving party only:
the seller receives the Order, the Order Change and the Order Cancellation, and sends no business response in this process.
A Message Level Response, if the parties agree to use one, belongs to {link-bis-36} and is a technical acknowledgement rather
than part of this process.
...
image::images/buyer-managed-ordering-roles.png[Roles in Buyer Managed Ordering]
