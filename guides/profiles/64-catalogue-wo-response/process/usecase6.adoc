...
This use case includes a simple catalogue containing articles showing how dietary claims and features can be codified.
...
3.  The articles are:
a.  Surgary gloves which are sterile.
